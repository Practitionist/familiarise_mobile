-- Generated from prompts/testing/unit/04-verification.md by scripts/gen-dev-seed.sh.
...
VALUES ('test_unit_verif_dom', 'Technology [test_unit_verif_dom]', NOW(), NOW()) ON CONFLICT (id) DO NOTHING;
