-- Generated from prompts/testing/unit/18-payout.md by scripts/gen-dev-seed.sh.
...
VALUES ('test_unit_payout_dom', 'Technology [test_unit_payout_dom]', NOW(), NOW()) ON CONFLICT (id) DO NOTHING;
