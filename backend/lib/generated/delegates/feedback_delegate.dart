...
class FeedbackDelegate {
  ...
  FeedbackDelegate(this._executor);

  /// Find a single Feedback by unique field(s)
  Future<Feedback?> findUnique({
    required FeedbackWhereUniqueInput where,
  }) async {
    ...
    return result != null ? Feedback.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single Feedback or throw if not found
  Future<Feedback> findUniqueOrThrow({
    required FeedbackWhereUniqueInput where,
  }) async {
  ...
  /// Find the first Feedback matching criteria
  Future<Feedback?> findFirst({
    FeedbackWhereInput? where,
    FeedbackOrderByInput? orderBy,
  }) async {
  ...
  /// Find multiple Feedbacks with optional filters
  Future<List<Feedback>> findMany({
    FeedbackWhereInput? where,
    FeedbackOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => Feedback.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new Feedback
  Future<Feedback> create({
    required CreateFeedbackInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Feedback')
    ...
    return Feedback.fromJson(_normalizeForJson(result));
  }

  /// Create multiple Feedbacks
  Future<int> createMany({
    required List<CreateFeedbackInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Feedback')
  ...
  Future<Feedback> update({
    required FeedbackWhereUniqueInput where,
    required UpdateFeedbackInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Feedback')
  ...
  Future<int> updateMany({
    required FeedbackWhereInput where,
    required UpdateFeedbackInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Feedback')
  ...
  /// Count Feedbacks matching criteria
  Future<int> count({
    FeedbackWhereInput? where,
  }) async {
    final queryBuilder = JsonQueryBuilder()
  ...
  /// Group Feedbacks by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(FeedbackWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(FeedbackWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as FeedbackWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is FeedbackWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(FeedbackOrderByInput orderBy) {
