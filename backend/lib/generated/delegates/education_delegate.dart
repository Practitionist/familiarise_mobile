...
class EducationDelegate {
  ...
  EducationDelegate(this._executor);

  /// Find a single Education by unique field(s)
  Future<Education?> findUnique({
    required EducationWhereUniqueInput where,
  }) async {
    ...
    return result != null ? Education.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single Education or throw if not found
  Future<Education> findUniqueOrThrow({
    required EducationWhereUniqueInput where,
  }) async {
    final result = await findUnique(where: where);
    if (result == null) {
      throw Exception('Education not found');
    }
    return result;
  }

  /// Find the first Education matching criteria
  Future<Education?> findFirst({
    EducationWhereInput? where,
    EducationOrderByInput? orderBy,
  }) async {
  ...
  /// Find multiple Educations with optional filters
  Future<List<Education>> findMany({
    EducationWhereInput? where,
    EducationOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => Education.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new Education
  Future<Education> create({
    required CreateEducationInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Education')
    ...
    return Education.fromJson(_normalizeForJson(result));
  }

  /// Create multiple Educations
  Future<int> createMany({
    required List<CreateEducationInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Education')
  ...
  /// Update a Education
  Future<Education> update({
    required EducationWhereUniqueInput where,
    required UpdateEducationInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Education')
  ...
  /// Update multiple Educations
  Future<int> updateMany({
    required EducationWhereInput where,
    required UpdateEducationInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Education')
  ...
  /// Count Educations matching criteria
  Future<int> count({
    EducationWhereInput? where,
  }) async {
    final queryBuilder = JsonQueryBuilder()
  ...
  /// Group Educations by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(EducationWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(EducationWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as EducationWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is EducationWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(EducationOrderByInput orderBy) {
