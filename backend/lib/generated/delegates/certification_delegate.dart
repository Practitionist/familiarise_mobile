...
class CertificationDelegate {
  ...
  CertificationDelegate(this._executor);

  /// Find a single Certification by unique field(s)
  Future<Certification?> findUnique({
    required CertificationWhereUniqueInput where,
  }) async {
    ...
    return result != null ? Certification.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single Certification or throw if not found
  Future<Certification> findUniqueOrThrow({
    required CertificationWhereUniqueInput where,
  }) async {
  ...
  /// Find the first Certification matching criteria
  Future<Certification?> findFirst({
    CertificationWhereInput? where,
    CertificationOrderByInput? orderBy,
  }) async {
  ...
  /// Find multiple Certifications with optional filters
  Future<List<Certification>> findMany({
    CertificationWhereInput? where,
    CertificationOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => Certification.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new Certification
  Future<Certification> create({
    required CreateCertificationInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Certification')
    ...
    return Certification.fromJson(_normalizeForJson(result));
  }

  /// Create multiple Certifications
  Future<int> createMany({
    required List<CreateCertificationInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Certification')
  ...
  Future<Certification> update({
    required CertificationWhereUniqueInput where,
    required UpdateCertificationInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Certification')
  ...
  Future<int> updateMany({
    required CertificationWhereInput where,
    required UpdateCertificationInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Certification')
  ...
  /// Count Certifications matching criteria
  Future<int> count({
    CertificationWhereInput? where,
  }) async {
    final queryBuilder = JsonQueryBuilder()
  ...
  /// Group Certifications by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(CertificationWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(CertificationWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as CertificationWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is CertificationWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(CertificationOrderByInput orderBy) {
