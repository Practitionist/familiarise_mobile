...
class SupportTicketAttachmentDelegate {
  final BaseExecutor _executor;

  SupportTicketAttachmentDelegate(this._executor);

  /// Find a single SupportTicketAttachment by unique field(s)
  Future<SupportTicketAttachment?> findUnique({
    required SupportTicketAttachmentWhereUniqueInput where,
  }) async {
    ...
    return result != null ? SupportTicketAttachment.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single SupportTicketAttachment or throw if not found
  Future<SupportTicketAttachment> findUniqueOrThrow({
    required SupportTicketAttachmentWhereUniqueInput where,
  }) async {
    final result = await findUnique(where: where);
    if (result == null) {
      throw Exception('SupportTicketAttachment not found');
    }
    return result;
  }

  /// Find the first SupportTicketAttachment matching criteria
  Future<SupportTicketAttachment?> findFirst({
    SupportTicketAttachmentWhereInput? where,
    SupportTicketAttachmentOrderByInput? orderBy,
  }) async {
  ...
  /// Find multiple SupportTicketAttachments with optional filters
  Future<List<SupportTicketAttachment>> findMany({
    SupportTicketAttachmentWhereInput? where,
    SupportTicketAttachmentOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => SupportTicketAttachment.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new SupportTicketAttachment
  Future<SupportTicketAttachment> create({
    required CreateSupportTicketAttachmentInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('SupportTicketAttachment')
    ...
    final result = await _executor.executeQueryAsSingleMap(query);
    if (result == null) {
      throw Exception('Failed to create SupportTicketAttachment');
    }
    return SupportTicketAttachment.fromJson(_normalizeForJson(result));
  }

  /// Create multiple SupportTicketAttachments
  Future<int> createMany({
    required List<CreateSupportTicketAttachmentInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('SupportTicketAttachment')
  ...
  /// Update a SupportTicketAttachment
  Future<SupportTicketAttachment> update({
    required SupportTicketAttachmentWhereUniqueInput where,
    required UpdateSupportTicketAttachmentInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('SupportTicketAttachment')
  ...
  /// Update multiple SupportTicketAttachments
  Future<int> updateMany({
    required SupportTicketAttachmentWhereInput where,
    required UpdateSupportTicketAttachmentInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('SupportTicketAttachment')
  ...
  Future<SupportTicketAttachment> delete({
    required SupportTicketAttachmentWhereUniqueInput where,
  }) async {
  ...
  /// Delete multiple SupportTicketAttachments
  ...
  /// Count SupportTicketAttachments matching criteria
  Future<int> count({
    SupportTicketAttachmentWhereInput? where,
  }) async {
    final queryBuilder = JsonQueryBuilder()
  ...
  /// Group SupportTicketAttachments by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(SupportTicketAttachmentWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(SupportTicketAttachmentWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as SupportTicketAttachmentWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is SupportTicketAttachmentWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(SupportTicketAttachmentOrderByInput orderBy) {
