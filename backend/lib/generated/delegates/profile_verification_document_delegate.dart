...
class ProfileVerificationDocumentDelegate {
  final BaseExecutor _executor;

  ProfileVerificationDocumentDelegate(this._executor);

  /// Find a single ProfileVerificationDocument by unique field(s)
  Future<ProfileVerificationDocument?> findUnique({
    required ProfileVerificationDocumentWhereUniqueInput where,
  }) async {
    ...
    return result != null ? ProfileVerificationDocument.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single ProfileVerificationDocument or throw if not found
  Future<ProfileVerificationDocument> findUniqueOrThrow({
    required ProfileVerificationDocumentWhereUniqueInput where,
  }) async {
    final result = await findUnique(where: where);
    if (result == null) {
      throw Exception('ProfileVerificationDocument not found');
    }
    return result;
  }

  /// Find the first ProfileVerificationDocument matching criteria
  Future<ProfileVerificationDocument?> findFirst({
    ProfileVerificationDocumentWhereInput? where,
    ProfileVerificationDocumentOrderByInput? orderBy,
  }) async {
  ...
  /// Find multiple ProfileVerificationDocuments with optional filters
  Future<List<ProfileVerificationDocument>> findMany({
    ProfileVerificationDocumentWhereInput? where,
    ProfileVerificationDocumentOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => ProfileVerificationDocument.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new ProfileVerificationDocument
  Future<ProfileVerificationDocument> create({
    required CreateProfileVerificationDocumentInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('ProfileVerificationDocument')
    ...
    final result = await _executor.executeQueryAsSingleMap(query);
    if (result == null) {
      throw Exception('Failed to create ProfileVerificationDocument');
    }
    return ProfileVerificationDocument.fromJson(_normalizeForJson(result));
  }

  /// Create multiple ProfileVerificationDocuments
  Future<int> createMany({
    required List<CreateProfileVerificationDocumentInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('ProfileVerificationDocument')
  ...
  /// Update a ProfileVerificationDocument
  Future<ProfileVerificationDocument> update({
    required ProfileVerificationDocumentWhereUniqueInput where,
    required UpdateProfileVerificationDocumentInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('ProfileVerificationDocument')
  ...
  /// Update multiple ProfileVerificationDocuments
  Future<int> updateMany({
    required ProfileVerificationDocumentWhereInput where,
    required UpdateProfileVerificationDocumentInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('ProfileVerificationDocument')
  ...
  /// Delete a ProfileVerificationDocument
  Future<ProfileVerificationDocument> delete({
    required ProfileVerificationDocumentWhereUniqueInput where,
  }) async {
  ...
  /// Delete multiple ProfileVerificationDocuments
  ...
  /// Count ProfileVerificationDocuments matching criteria
  Future<int> count({
    ProfileVerificationDocumentWhereInput? where,
  }) async {
    final queryBuilder = JsonQueryBuilder()
  ...
  /// Group ProfileVerificationDocuments by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(ProfileVerificationDocumentWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(ProfileVerificationDocumentWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as ProfileVerificationDocumentWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is ProfileVerificationDocumentWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(ProfileVerificationDocumentOrderByInput orderBy) {
