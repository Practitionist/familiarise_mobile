...
class WorkExperienceDelegate {
  ...
  WorkExperienceDelegate(this._executor);

  /// Find a single WorkExperience by unique field(s)
  Future<WorkExperience?> findUnique({
    required WorkExperienceWhereUniqueInput where,
  }) async {
    ...
    return result != null ? WorkExperience.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single WorkExperience or throw if not found
  Future<WorkExperience> findUniqueOrThrow({
    required WorkExperienceWhereUniqueInput where,
  }) async {
    final result = await findUnique(where: where);
    if (result == null) {
      throw Exception('WorkExperience not found');
    }
    return result;
  }

  /// Find the first WorkExperience matching criteria
  Future<WorkExperience?> findFirst({
    WorkExperienceWhereInput? where,
    WorkExperienceOrderByInput? orderBy,
  }) async {
  ...
  /// Find multiple WorkExperiences with optional filters
  Future<List<WorkExperience>> findMany({
    WorkExperienceWhereInput? where,
    WorkExperienceOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => WorkExperience.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new WorkExperience
  Future<WorkExperience> create({
    required CreateWorkExperienceInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('WorkExperience')
    ...
    final result = await _executor.executeQueryAsSingleMap(query);
    if (result == null) {
      throw Exception('Failed to create WorkExperience');
    }
    return WorkExperience.fromJson(_normalizeForJson(result));
  }

  /// Create multiple WorkExperiences
  Future<int> createMany({
    required List<CreateWorkExperienceInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('WorkExperience')
  ...
  Future<WorkExperience> update({
    required WorkExperienceWhereUniqueInput where,
    required UpdateWorkExperienceInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('WorkExperience')
  ...
  /// Update multiple WorkExperiences
  Future<int> updateMany({
    required WorkExperienceWhereInput where,
    required UpdateWorkExperienceInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('WorkExperience')
  ...
  /// Delete multiple WorkExperiences
  ...
  /// Count WorkExperiences matching criteria
  Future<int> count({
    WorkExperienceWhereInput? where,
  }) async {
    final queryBuilder = JsonQueryBuilder()
  ...
  /// Group WorkExperiences by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(WorkExperienceWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(WorkExperienceWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as WorkExperienceWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is WorkExperienceWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(WorkExperienceOrderByInput orderBy) {
