...
class AppointmentDelegate {
  ...
  AppointmentDelegate(this._executor);

  /// Find a single Appointment by unique field(s)
  Future<Appointment?> findUnique({
    required AppointmentWhereUniqueInput where,
  }) async {
    ...
    return result != null ? Appointment.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single Appointment or throw if not found
  Future<Appointment> findUniqueOrThrow({
    required AppointmentWhereUniqueInput where,
  }) async {
  ...
  /// Find the first Appointment matching criteria
  Future<Appointment?> findFirst({
    AppointmentWhereInput? where,
    AppointmentOrderByInput? orderBy,
  }) async {
  ...
  /// Find multiple Appointments with optional filters
  Future<List<Appointment>> findMany({
    AppointmentWhereInput? where,
    AppointmentOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => Appointment.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new Appointment
  Future<Appointment> create({
    required CreateAppointmentInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Appointment')
    ...
    return Appointment.fromJson(_normalizeForJson(result));
  }

  /// Create multiple Appointments
  Future<int> createMany({
    required List<CreateAppointmentInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Appointment')
  ...
  Future<Appointment> update({
    required AppointmentWhereUniqueInput where,
    required UpdateAppointmentInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Appointment')
  ...
  Future<int> updateMany({
    required AppointmentWhereInput where,
    required UpdateAppointmentInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Appointment')
  ...
  /// Count Appointments matching criteria
  Future<int> count({
    AppointmentWhereInput? where,
  }) async {
    final queryBuilder = JsonQueryBuilder()
  ...
  /// Group Appointments by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(AppointmentWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(AppointmentWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as AppointmentWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is AppointmentWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(AppointmentOrderByInput orderBy) {
