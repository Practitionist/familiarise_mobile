...
class OrganizationDelegate {
  ...
  OrganizationDelegate(this._executor);

  /// Find a single Organization by unique field(s)
  Future<Organization?> findUnique({
    required OrganizationWhereUniqueInput where,
  }) async {
    ...
    return result != null ? Organization.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single Organization or throw if not found
  Future<Organization> findUniqueOrThrow({
    required OrganizationWhereUniqueInput where,
  }) async {
  ...
  /// Find the first Organization matching criteria
  Future<Organization?> findFirst({
    OrganizationWhereInput? where,
    OrganizationOrderByInput? orderBy,
  }) async {
  ...
  /// Find multiple Organizations with optional filters
  Future<List<Organization>> findMany({
    OrganizationWhereInput? where,
    OrganizationOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => Organization.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new Organization
  Future<Organization> create({
    required CreateOrganizationInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Organization')
    ...
    return Organization.fromJson(_normalizeForJson(result));
  }

  /// Create multiple Organizations
  Future<int> createMany({
    required List<CreateOrganizationInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Organization')
  ...
  Future<Organization> update({
    required OrganizationWhereUniqueInput where,
    required UpdateOrganizationInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Organization')
  ...
  Future<int> updateMany({
    required OrganizationWhereInput where,
    required UpdateOrganizationInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Organization')
  ...
  /// Group Organizations by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(OrganizationWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(OrganizationWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as OrganizationWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is OrganizationWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(OrganizationOrderByInput orderBy) {
