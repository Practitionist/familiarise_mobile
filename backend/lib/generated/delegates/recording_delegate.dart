...
class RecordingDelegate {
  ...
  RecordingDelegate(this._executor);

  /// Find a single Recording by unique field(s)
  Future<Recording?> findUnique({
    required RecordingWhereUniqueInput where,
  }) async {
    ...
    return result != null ? Recording.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single Recording or throw if not found
  Future<Recording> findUniqueOrThrow({
    required RecordingWhereUniqueInput where,
  }) async {
  ...
  /// Find the first Recording matching criteria
  Future<Recording?> findFirst({
    RecordingWhereInput? where,
    RecordingOrderByInput? orderBy,
  }) async {
  ...
  /// Find multiple Recordings with optional filters
  Future<List<Recording>> findMany({
    RecordingWhereInput? where,
    RecordingOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => Recording.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new Recording
  Future<Recording> create({
    required CreateRecordingInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Recording')
    ...
    return Recording.fromJson(_normalizeForJson(result));
  }

  /// Create multiple Recordings
  Future<int> createMany({
    required List<CreateRecordingInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Recording')
  ...
  /// Update a Recording
  Future<Recording> update({
    required RecordingWhereUniqueInput where,
    required UpdateRecordingInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Recording')
  ...
  Future<int> updateMany({
    required RecordingWhereInput where,
    required UpdateRecordingInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Recording')
  ...
  /// Count Recordings matching criteria
  Future<int> count({
    RecordingWhereInput? where,
  }) async {
    final queryBuilder = JsonQueryBuilder()
  ...
  /// Group Recordings by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(RecordingWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(RecordingWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as RecordingWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is RecordingWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(RecordingOrderByInput orderBy) {
