...
class VerificationDelegate {
  ...
  VerificationDelegate(this._executor);

  /// Find a single Verification by unique field(s)
  Future<Verification?> findUnique({
    required VerificationWhereUniqueInput where,
  }) async {
    ...
    return result != null ? Verification.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single Verification or throw if not found
  Future<Verification> findUniqueOrThrow({
    required VerificationWhereUniqueInput where,
  }) async {
  ...
  /// Find the first Verification matching criteria
  Future<Verification?> findFirst({
    VerificationWhereInput? where,
    VerificationOrderByInput? orderBy,
  }) async {
  ...
  /// Find multiple Verifications with optional filters
  Future<List<Verification>> findMany({
    VerificationWhereInput? where,
    VerificationOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => Verification.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new Verification
  Future<Verification> create({
    required CreateVerificationInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Verification')
    ...
    return Verification.fromJson(_normalizeForJson(result));
  }

  /// Create multiple Verifications
  Future<int> createMany({
    required List<CreateVerificationInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Verification')
  ...
  Future<Verification> update({
    required VerificationWhereUniqueInput where,
    required UpdateVerificationInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Verification')
  ...
  /// Update multiple Verifications
  Future<int> updateMany({
    required VerificationWhereInput where,
    required UpdateVerificationInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Verification')
  ...
  /// Count Verifications matching criteria
  Future<int> count({
    VerificationWhereInput? where,
  }) async {
    final queryBuilder = JsonQueryBuilder()
  ...
  /// Group Verifications by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(VerificationWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(VerificationWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as VerificationWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is VerificationWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(VerificationOrderByInput orderBy) {
