...
class SubscriptionDelegate {
  ...
  SubscriptionDelegate(this._executor);

  /// Find a single Subscription by unique field(s)
  Future<Subscription?> findUnique({
    required SubscriptionWhereUniqueInput where,
  }) async {
    ...
    return result != null ? Subscription.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single Subscription or throw if not found
  Future<Subscription> findUniqueOrThrow({
    required SubscriptionWhereUniqueInput where,
  }) async {
  ...
  /// Find the first Subscription matching criteria
  Future<Subscription?> findFirst({
    SubscriptionWhereInput? where,
    SubscriptionOrderByInput? orderBy,
  }) async {
  ...
  Future<List<Subscription>> findMany({
    SubscriptionWhereInput? where,
    SubscriptionOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => Subscription.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new Subscription
  Future<Subscription> create({
    required CreateSubscriptionInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Subscription')
    ...
    return Subscription.fromJson(_normalizeForJson(result));
  }

  /// Create multiple Subscriptions
  Future<int> createMany({
    required List<CreateSubscriptionInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Subscription')
  ...
  Future<Subscription> update({
    required SubscriptionWhereUniqueInput where,
    required UpdateSubscriptionInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Subscription')
  ...
  Future<int> updateMany({
    required SubscriptionWhereInput where,
    required UpdateSubscriptionInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('Subscription')
  ...
  /// Group Subscriptions by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(SubscriptionWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(SubscriptionWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as SubscriptionWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is SubscriptionWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(SubscriptionOrderByInput orderBy) {
