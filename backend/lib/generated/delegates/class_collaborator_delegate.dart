...
class ClassCollaboratorDelegate {
  final BaseExecutor _executor;

  ClassCollaboratorDelegate(this._executor);

  /// Find a single ClassCollaborator by unique field(s)
  Future<ClassCollaborator?> findUnique({
    required ClassCollaboratorWhereUniqueInput where,
  }) async {
    ...
    return result != null ? ClassCollaborator.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single ClassCollaborator or throw if not found
  Future<ClassCollaborator> findUniqueOrThrow({
    required ClassCollaboratorWhereUniqueInput where,
  }) async {
    final result = await findUnique(where: where);
    if (result == null) {
      throw Exception('ClassCollaborator not found');
    }
    return result;
  }

  /// Find the first ClassCollaborator matching criteria
  Future<ClassCollaborator?> findFirst({
    ClassCollaboratorWhereInput? where,
    ClassCollaboratorOrderByInput? orderBy,
  }) async {
  ...
  /// Find multiple ClassCollaborators with optional filters
  Future<List<ClassCollaborator>> findMany({
    ClassCollaboratorWhereInput? where,
    ClassCollaboratorOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => ClassCollaborator.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new ClassCollaborator
  Future<ClassCollaborator> create({
    required CreateClassCollaboratorInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('ClassCollaborator')
    ...
    final result = await _executor.executeQueryAsSingleMap(query);
    if (result == null) {
      throw Exception('Failed to create ClassCollaborator');
    }
    return ClassCollaborator.fromJson(_normalizeForJson(result));
  }

  /// Create multiple ClassCollaborators
  Future<int> createMany({
    required List<CreateClassCollaboratorInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('ClassCollaborator')
  ...
  /// Update a ClassCollaborator
  Future<ClassCollaborator> update({
    required ClassCollaboratorWhereUniqueInput where,
    required UpdateClassCollaboratorInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('ClassCollaborator')
  ...
  /// Update multiple ClassCollaborators
  Future<int> updateMany({
    required ClassCollaboratorWhereInput where,
    required UpdateClassCollaboratorInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('ClassCollaborator')
  ...
  /// Delete a ClassCollaborator
  Future<ClassCollaborator> delete({
    required ClassCollaboratorWhereUniqueInput where,
  }) async {
  ...
  /// Delete multiple ClassCollaborators
  ...
  /// Count ClassCollaborators matching criteria
  Future<int> count({
    ClassCollaboratorWhereInput? where,
  }) async {
    final queryBuilder = JsonQueryBuilder()
  ...
  /// Group ClassCollaborators by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(ClassCollaboratorWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(ClassCollaboratorWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as ClassCollaboratorWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is ClassCollaboratorWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(ClassCollaboratorOrderByInput orderBy) {
