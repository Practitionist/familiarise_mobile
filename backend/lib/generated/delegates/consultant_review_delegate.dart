...
class ConsultantReviewDelegate {
  ...
  ConsultantReviewDelegate(this._executor);

  /// Find a single ConsultantReview by unique field(s)
  Future<ConsultantReview?> findUnique({
    required ConsultantReviewWhereUniqueInput where,
  }) async {
    ...
    return result != null ? ConsultantReview.fromJson(_normalizeForJson(result)) : null;
  }

  /// Find a single ConsultantReview or throw if not found
  Future<ConsultantReview> findUniqueOrThrow({
    required ConsultantReviewWhereUniqueInput where,
  }) async {
    final result = await findUnique(where: where);
    if (result == null) {
      throw Exception('ConsultantReview not found');
    }
    return result;
  }

  /// Find the first ConsultantReview matching criteria
  Future<ConsultantReview?> findFirst({
    ConsultantReviewWhereInput? where,
    ConsultantReviewOrderByInput? orderBy,
  }) async {
  ...
  /// Find multiple ConsultantReviews with optional filters
  Future<List<ConsultantReview>> findMany({
    ConsultantReviewWhereInput? where,
    ConsultantReviewOrderByInput? orderBy,
    int? take,
    int? skip,
    ...
    return results.map((json) => ConsultantReview.fromJson(_normalizeForJson(json))).toList();
  }

  /// Create a new ConsultantReview
  Future<ConsultantReview> create({
    required CreateConsultantReviewInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('ConsultantReview')
    ...
    final result = await _executor.executeQueryAsSingleMap(query);
    if (result == null) {
      throw Exception('Failed to create ConsultantReview');
    }
    return ConsultantReview.fromJson(_normalizeForJson(result));
  }

  /// Create multiple ConsultantReviews
  Future<int> createMany({
    required List<CreateConsultantReviewInput> data,
  }) async {
    final query = JsonQueryBuilder()
        .model('ConsultantReview')
  ...
  /// Update a ConsultantReview
  Future<ConsultantReview> update({
    required ConsultantReviewWhereUniqueInput where,
    required UpdateConsultantReviewInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('ConsultantReview')
  ...
  /// Update multiple ConsultantReviews
  Future<int> updateMany({
    required ConsultantReviewWhereInput where,
    required UpdateConsultantReviewInput data,
  }) async {
    final query = JsonQueryBuilder()
        .model('ConsultantReview')
  ...
  /// Delete a ConsultantReview
  Future<ConsultantReview> delete({
    required ConsultantReviewWhereUniqueInput where,
  }) async {
  ...
  /// Delete multiple ConsultantReviews
  ...
  /// Count ConsultantReviews matching criteria
  Future<int> count({
    ConsultantReviewWhereInput? where,
  }) async {
    final queryBuilder = JsonQueryBuilder()
  ...
  /// Group ConsultantReviews by fields with aggregations
  ...
  Map<String, dynamic> _whereUniqueToJson(ConsultantReviewWhereUniqueInput where) {
    return where.toJson()..removeWhere((key, value) => value == null);
  }

  /// Convert WhereInput to JSON for JsonQueryBuilder
  Map<String, dynamic> _whereToJson(ConsultantReviewWhereInput where) {
      ...
      if (entry.key == 'AND' || entry.key == 'OR') {
        ...
        if (list != null && list.isNotEmpty) {
          result[entry.key] = list.map((item) {
            ...
            return (item as ConsultantReviewWhereInput).toJson();
          }).toList();
        }
        ...
        } else if (not is ConsultantReviewWhereInput) {
  ...
  Map<String, dynamic> _orderByToJson(ConsultantReviewOrderByInput orderBy) {
