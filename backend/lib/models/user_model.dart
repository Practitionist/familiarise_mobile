class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
      ...
      role: UserRole.fromString(json['role'] as String? ?? 'CONSULTEE'),
  ...
  Map<String, dynamic> toJsonSafe() {
    // Version without sensitive fields like password
    final json = toJson();
    json.remove('password');
    json.remove('passwordResetToken');
    json.remove('passwordResetExpires');
    return json;
  }
